...
- ❌ Never alert AK directly unless severity is Critical — route through Captain for High and below
...
- ❌ Never restart agents or modify configurations — that's Captain's job
