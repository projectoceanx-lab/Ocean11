...
- **Email:** Email Engine (for buyer outreach)
...
- `gog` CLI available for Gmail — useful for buyer outreach emails
- `gog gmail send` — send outreach to new buyers
- `gog contacts` — manage buyer contacts
