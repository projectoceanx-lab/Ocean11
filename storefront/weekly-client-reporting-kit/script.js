(function () {
  ...
  function requestInvoice() {
    ...
    const subject = encodeURIComponent('Weekly Client Reporting Kit - Manual Invoice Request');
    const body = encodeURIComponent(`Please send invoice for Weekly Client Reporting Kit.\nBuyer email: ${email}`);
