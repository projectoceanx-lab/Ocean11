(function () {
  ...
  function requestInvoice() {
    ...
    const subject = encodeURIComponent('Creative Testing Sprint Kit - Manual Invoice Request');
    const body = encodeURIComponent(`Please send invoice for Creative Testing Sprint Kit.\nBuyer email: ${email}`);
