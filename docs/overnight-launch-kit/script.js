(function () {
  ...
  function requestInvoice() {
    ...
    const subject = encodeURIComponent('Overnight Launch Kit - Manual Invoice Request');
    const body = encodeURIComponent(`Please send invoice for Overnight Launch Kit.\nBuyer email: ${email}`);
